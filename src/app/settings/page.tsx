...
export default function Page() {
  return (
    <div className="flex w-full h-screen bg-[#14191f]">
      <SideNav />
      <div className="layout-container flex h-screen w-full items-center justify-center flex-col">
        <form className="layout-content-container flex flex-col w-full justify-start items-center py-5 flex-1 h-full">
