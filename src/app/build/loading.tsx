const ResumePageSkeleton = () => {
  return (
    <div className="flex w-full h-screen bg-[#0f172a] animate-pulse">
      ...
      <div className="w-[250px] bg-[#1e293b] h-full p-4 flex justify-baseline flex-col gap-4">
        ...
        <div className="h-10 bg-gray-600 rounded w-1/2 mt-10" />
      </div>

      {/* Center Resume Skeleton */}
      <div className="flex-1 p-8 bg-[#1e293b]">
        <div className="mx-auto max-w-[800px] bg-gray-800 p-8 flex flex-col gap-4 rounded shadow-lg">
          <div className="h-6 w-1/3 bg-gray-600 rounded mb-4" />
          <div className="h-4 w-1/4 bg-gray-700 rounded mb-6" />
      ...
      <div className="w-[420px] bg-[#1e293b] p-6 flex flex-col">
        <div className="h-6 bg-gray-600 rounded w-2/3 mb-4" />
        <div className="h-4 bg-gray-500 rounded w-full mb-6" />
        <div className="h-10 bg-gray-700 rounded w-1/2 mb-4" />
        <div className="h-10 bg-gray-700 rounded w-1/2 mb-6" />

        <div className="flex-1 bg-gray-800 rounded-lg p-4 space-y-2 overflow-y-auto">
          {[...Array(12)].map((_, i) => (
